...
private JLabel lblSelectAnAlgoritham;
/**
...
Color myBlue  = new Color(0, 100, 255);
desktopPane.setBackground(myBlue);
contentPane.add(desktopPane, BorderLayout.CENTER);
addCarBtn.setBounds(16, 265, 108, 29);
useACOBtn.setBounds(11, 377, 108, 29);
useGABtn.setBounds(11, 428, 108, 29);
testBtn.setBounds(16, 565, 108, 29);
//lblGA.setBounds(156,365, 50, 29);
lblACOph.setBounds(116, 376, 50, 29);
lblACOpr.setBounds(166, 376, 50, 29);
lblACOev.setBounds(216, 376, 50, 29);
...
desktopPane.add(lblSelectAnAlgoritham);
/*
